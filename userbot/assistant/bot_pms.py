    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**⌔︙ اهلا وسهلا اخوي  {mention} **\
                        ...
                        \n\n**⌔︙ البوت خاص بسورس :** [SELVA FOR SEZR](https://t.me/M4_STORY)"
        buttons = [
            (
...
@SU_SELVA.bot_cmd(incoming=True, func=lambda e: e.is_private)
...
@SU_SELVA.tgbot.on(CallbackQuery(data=re.compile(b"bot_pm_ban_([0-9]+)")))
@ttccss
...
@SU_SELVA.tgbot.on(CallbackQuery(data=re.compile(b"toggle_bot-antiflood_off$")))
@ttccss
...
@SU_SELVA.bot_cmd(incoming=True, func=lambda e: e.is_private)
@SU_SELVA.bot_cmd(edited=True, func=lambda e: e.is_private)
